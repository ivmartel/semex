/**
* \file ApplyMaskImageFilterParallelTests.cpp
* \brief Implementation of tests of the thelib::ApplyMaskImageFilterParallel class.
*/
...
bool RunMask( const std::string& testDataPath, bool invertMask )
{
	...
	typedef thelib::ApplyMaskImageFilterParallel< ImageType > FilterType;
...
int main (int argc, char *argv[])
{
    ...
    // run tests
    if( !RunMask( testDataPath, false ) ) return EXIT_FAILURE;
    if( !RunMask( testDataPath, true ) ) return EXIT_FAILURE;
